...
const Login = () => {
    ...
    return (
        <div className='h-screen relative flex items-center justify-end'>
            ...
            <div className='relative flex flex-col items-center gap-4 h-full p-24 w-full md:w-1/3 justify-center z-10 rounded-l-xl bg-primary-600 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-30 border border-gray-100'>
                <h1 className='text-red text-2xl font-bold'>BIENVENIDO</h1>
                {!selectedTab ? (
